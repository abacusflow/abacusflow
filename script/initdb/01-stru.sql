...
(
    ...
    type          varchar(255)
        constraint products_type_check
            check ((type)::text = ANY
                   (ARRAY [('MATERIAL'::character varying)::text, ('ASSET'::character varying)::text])),
    unit          varchar(255) not null
        constraint products_unit_check
            check ((unit)::text = ANY
                   (ARRAY [('PIECE'::character varying)::text, ('BOX'::character varying)::text, ('PACK'::character varying)::text, ('DOZEN'::character varying)::text, ('PAIR'::character varying)::text, ('GRAM'::character varying)::text, ('KILOGRAM'::character varying)::text, ('LITER'::character varying)::text, ('MILLILITER'::character varying)::text, ('METER'::character varying)::text, ('CENTIMETER'::character varying)::text, ('BOTTLE'::character varying)::text, ('BARREL'::character varying)::text, ('BAG'::character varying)::text, ('SHEET'::character varying)::text, ('ROLL'::character varying)::text, ('ITEM'::character varying)::text])),
    updated_at    timestamp(6) with time zone,
    ...
    status      varchar(255)
        constraint purchase_orders_status_check
            check ((status)::text = ANY
                   (ARRAY [('PENDING'::character varying)::text, ('COMPLETED'::character varying)::text, ('CANCELED'::character varying)::text, ('REVERSED'::character varying)::text])),
    ...
    inventory_unit_type varchar(255)
        constraint sale_order_items_inventory_unit_type_check
            check ((inventory_unit_type)::text = ANY
                   (ARRAY [('INSTANCE'::character varying)::text, ('BATCH'::character varying)::text])),
    quantity            integer not null,
    unit_price          numeric(38, 2),
    order_id            bigint
...
(
    ...
    sex        varchar(255)
        constraint users_sex_check
            check ((sex)::text = ANY (ARRAY [('M'::character varying)::text, ('F'::character varying)::text])),
    updated_at timestamp(6) with time zone not null
);
...
(
    ...
    status            varchar(255) not null
        constraint inventory_unit_status_check
            check ((status)::text = ANY
                   (ARRAY [('NORMAL'::character varying)::text, ('CONSUMED'::character varying)::text, ('CANCELED'::character varying)::text, ('REVERSED'::character varying)::text])),
    unit_price        numeric(38, 2),
    updated_at        timestamp(6) with time zone,
