-- ✅ 枚举类型定义
create type enum_product_type as enum ('MATERIAL', 'ASSET');
create type enum_product_unit as enum (
    'PIECE', 'BOX', 'PACK', 'DOZEN', 'PAIR', 'GRAM', 'KILOGRAM', 'LITER',
    'MILLILITER', 'METER', 'CENTIMETER', 'BOTTLE', 'BARREL', 'BAG', 'SHEET', 'ROLL', 'ITEM'
    );
create type enum_purchase_status as enum ('PENDING', 'COMPLETED', 'CANCELED', 'REVERSED');
create type enum_sale_status as enum ('PENDING', 'COMPLETED', 'CANCELED', 'REVERSED');
create type enum_inventory_status as enum ('NORMAL', 'CONSUMED', 'CANCELED', 'REVERSED');
create type enum_inventory_unit_type as enum ('INSTANCE', 'BATCH');
create type enum_user_sex as enum ('M', 'F');
...
create table product (
                         ...
                         unit enum_product_unit not null,
...
create table inventory_unit (
                                ...
                                status enum_inventory_status not null,
...
create table purchase_order_item (
                                     ...
                                     product_type enum_product_type,
...
create table sale_order_item (
                                 ...
                                 inventory_unit_type enum_inventory_unit_type,
                                 quantity integer not null,
                                 unit_price numeric(38, 2),
