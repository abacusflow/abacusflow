...
openApiGenerate {
    ...
    outputDir =
        layout.buildDirectory
            ...
            .get()
            .asFile.absolutePath
    apiPackage = "org.bruwave.invenflow.portal.web.api"
    invokerPackage = "org.bruwave.invenflow.portal.web.invoker"
    modelPackage = "org.bruwave.invenflow.portal.web.model"
    configOptions.set(
        mapOf(
