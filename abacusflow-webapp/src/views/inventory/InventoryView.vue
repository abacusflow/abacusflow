...
import type { BasicInventory, Inventory, CreateInventoryInput, UpdateInventoryInput } from '@/core/openapi/models'
...
const handleSubmit = async () => {
  try {
    ...
    if (modalType.value === 'add') {
      ...
      const inventory = inventories.value.find(i => 
        i.productId === form.value.productId && 
        i.warehouseId === form.value.warehouseId
      )
      if (inventory) {
